...
CREATE TABLE IF NOT EXISTS fsm_users ( -- user is a reserved word
    ...
    user_name VARCHAR, -- name is a reserved word
    user_role VARCHAR,
    photo_path VARCHAR -- before 'archivo_foto', is a minio path
);
...
CREATE TABLE IF NOT EXISTS technicians (
    ...
    FOREIGN KEY (email) REFERENCES fsm_users(email)
);
...
CREATE TABLE IF NOT EXISTS tickets (
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(), --Convert to UTC on save. Reconvert at timezone which must be include in query
    created_by VARCHAR,
    ...
    FOREIGN KEY (created_by) REFERENCES fsm_users(email),
    FOREIGN KEY (updated_by) REFERENCES fsm_users(email)
...
CREATE TABLE IF NOT EXISTS cancellations (
    ...
    cancellation_responsible VARCHAR,
    ...
    FOREIGN KEY (cancellation_responsible) REFERENCES fsm_users(email),
    FOREIGN KEY (created_by) REFERENCES fsm_users(email),
    FOREIGN KEY (updated_by) REFERENCES fsm_users(email)
);
...
CREATE TABLE IF NOT EXISTS adticketswkd (
    ...
    minimarket_temperature NUMERIC,
